            ...
            <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              ...
              <div className="w-full">
                ...
                <p className="text-sm sm:text-base md:text-lg text-gray-400">
                  Experience the amazing world of {1} with exciting gameplay and music
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 space-y-6">
              <div className="p-4 sm:p-6 bg-black/50 rounded-xl">
                ...
                <p className="text-sm sm:text-base text-gray-300 mb-4">
                  Dive into the fascinating world of {1}, a unique gaming experience that combines music, creativity, and fun. This game offers a refreshing take on the classic Incredibox concept with new features and exciting gameplay elements.
                </p>
              ...
              <div className="p-4 sm:p-6 bg-black/50 rounded-xl">
                ...
                <div className="space-y-4">
                  <div className="border-b border-[#2EE59D]/10 pb-4">
                    <h3 className="text-lg font-medium text-white mb-2">What is {1}?</h3>
                    <p className="text-gray-400">{1} is an interactive music game that allows players to create unique musical compositions through an intuitive and engaging interface.</p>
                  </div>
                  ...
                  <div className="border-b border-[#2EE59D]/10 pb-4">
                    ...
                    <p className="text-gray-400">Yes, {1} is completely free to play on our website.</p>
                  </div>

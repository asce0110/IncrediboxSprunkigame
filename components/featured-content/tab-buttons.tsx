  ...
  return (
    <div className="flex gap-6">
      ...
      >
        ...
        {activeTab === 'gaming' && (
          <>
            <div className="absolute -inset-4 bg-[#2EE59D]/20 blur-2xl rounded-full" />
            <div className="absolute -inset-3 bg-[#2EE59D]/30 blur-xl rounded-[30px] rotate-6" />
            <div className="absolute -inset-2 bg-[#2EE59D]/40 blur-lg rounded-[20px] -rotate-3" />
            <div className="absolute inset-0 bg-[#2EE59D] blur-md rounded-2xl" />
          </>
        )}
        
        {/* 悬停状态的发光效果 */}
        <div className={`absolute -inset-4 bg-[#2EE59D]/10 blur-2xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
          activeTab === 'gaming' ? 'hidden' : ''
        }`} />
        
        {/* 按钮内容 */}
        <div className={`relative flex items-center gap-3 px-8 py-3 rounded-xl transition-all duration-500 ${
          activeTab === 'gaming'

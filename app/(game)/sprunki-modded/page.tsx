...
export default function SprunckiModdedPage() {
  ...
  return (
    <>
      <Head>
        <title>Sprunki Modded - Play the Enhanced Version of Music Creation Game</title>
        <meta name="description" content="Play Sprunki Modded online - Experience the enhanced version of music creation with new features, modern beats, and innovative tools. Create, mix, and share your musical masterpieces!" />
        <meta name="keywords" content="Sprunki Modded, music creation game, online music game, Sprunki mod, modded game" />
      </Head>
